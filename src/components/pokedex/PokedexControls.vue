    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          You currently have the selection option active. Do you want to export the selected ({{ selected.size }}
          pokémons) ? Or all of your Pokédex ?
        </AlertDialogDescription>
      </AlertDialogHeader>

      <AlertDialogFooter>
        <AlertDialogAction size="sm" @click="exportFull">Export Full Pokédex</AlertDialogAction>
        <AlertDialogAction size="sm" @click="exportSelected">Export Selected Pokémons</AlertDialogAction>
